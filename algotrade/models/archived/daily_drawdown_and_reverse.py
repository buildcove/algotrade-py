...
- If the drawdown is greater than N ticks, it means when it reverse to the opening price it will continue on that direction
- The entry is at the opening price
...
Result:
Param brute force, tick_signal from 1-30 and tick_stoploss from 1-30.
Close time: 15:30 nor 8:30

0% win rate regardless of the parameters. The strategy is not profitable.
"""
...
class Backtest:
    ...
    def run(self):
        ...
        for i, row in enumerate(self.data):
            ...
            # Take profit when the time is 15:30 (30 mins before close)
